...
<body>
    ...
    <header class="dash-topbar">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex items-center gap-2" style="border-left: 1px solid var(--border); padding-left: 0.75rem;">
          ...
          <div>
            <div id="dashUserName" style="font-size: 0.8125rem; font-weight: 800; color: var(--primary);">Selva</div>
            <div id="dashUserEmail" style="font-size: 0.6875rem; color: var(--text-muted);">selva@hisabhero.com</div>
          </div>
        </div>
    ...
    <div class="dash-layout">
      ...
      <main class="dash-main">
        ...
        <div id="section-overview">
          <!-- Hero Banner with 0-100 Gauge Arc -->
          <div class="dash-hero-banner">
            ...
            <div class="flex items-center gap-4" style="background: rgba(255,255,255,0.06); padding: 0.75rem 1.25rem; border-radius: 16px; border: 1px solid rgba(255,255,255,0.1);">
              <div style="text-align: center;">
                <div style="font-size: 0.75rem; color: #94a3b8; text-transform: uppercase; font-weight: 800;">Health Gauge</div>
                <div style="font-size: 1.75rem; font-weight: 900; color: #10b981; font-family: var(--font-display);">88/100</div>
              </div>
              <div style="width: 2px; height: 36px; background: rgba(255,255,255,0.1);"></div>
              <div>
                <div style="font-size: 0.8125rem; font-weight: 800; color: #6ee7b7;">EXCELLENT</div>
                <div style="font-size: 0.6875rem; color: #cbd5e1;">Healthy liquidity & low burn</div>
              </div>
            </div>
          ...
          <div style="background: #ecfdf5; border: 1px solid #a7f3d0; border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.5rem; display: flex; align-items: center; justify-content: space-between;">
            <div class="flex items-center gap-3">
              <span style="font-size: 1.5rem;">🤖</span>
              <div>
                <strong style="color: #065f46; font-size: 0.9375rem;">AI CFO Proactive Insight:</strong>
                <div style="font-size: 0.8125rem; color: #047857; margin-top: 2px;">
                  ₹18,400 in unclaimed Input Tax Credits (ITC) detected from verified vendor receipts. Auto-filing recommended.
                </div>
              </div>
            </div>
          ...
          <div class="metrics-grid">
            ...
            <div class="metric-card">
              ...
              <div id="statRunway" class="metric-value" style="color: var(--secondary);">12.4 Mos</div>
              <div class="metric-sub">SAFE BUFFER</div>
            </div>
          </div>

          <!-- ─── INTERACTIVE FINANCIAL GRAPHS ─── -->
          <div class="charts-grid">
            <!-- Graph 1: Inflow vs Outflow Trend -->
            <div class="chart-card">
              <div class="flex justify-between items-center" style="margin-bottom: 1rem;">
                <div>
                  <h3 style="font-size: 1.1rem;">Cash Flow & Expense Trend</h3>
                  <p style="font-size: 0.8125rem; color: var(--text-muted);">Monthly comparison of Inflow vs. Outflow</p>
                </div>
                <span class="pill-badge" style="font-size: 0.7rem; padding: 2px 8px;">6-MONTH VIEW</span>
              </div>
            ...
            <div class="chart-card">
              <div class="flex justify-between items-center" style="margin-bottom: 1rem;">
                <div>
                  ...
                  <p style="font-size: 0.8125rem; color: var(--text-muted);">Distribution by category</p>
                </div>
                <span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 8px;">ACTIVE</span>
              </div>
              <div style="height: 260px; position: relative;">
        ...
        <div id="section-khata" style="display: none;">
          <div class="data-table-card">
            <div class="flex justify-between items-center" style="margin-bottom: 1.5rem;">
              ...
              <button class="btn btn-accent" onclick="alert('Add party dialog ready!')">+ Add Party</button>
            </div>
            ...
            <div class="flex gap-4" style="margin-bottom: 1.5rem;">
              <div style="flex: 1; background: #ecfdf5; border: 1px solid #a7f3d0; padding: 1.25rem; border-radius: 12px;">
                ...
                <div style="font-size: 1.75rem; font-weight: 900; color: #059669; margin: 4px 0;">₹1,45,000</div>
                <div style="font-size: 0.75rem; color: #047857;">Across 3 customer accounts</div>
              </div>
              <div style="flex: 1; background: #fef2f2; border: 1px solid #fecaca; padding: 1.25rem; border-radius: 12px;">
                ...
                <div style="font-size: 1.75rem; font-weight: 900; color: #dc2626; margin: 4px 0;">₹38,500</div>
                <div style="font-size: 0.75rem; color: #b91c1c;">Across 2 vendor accounts</div>
              </div>
            </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><strong>Apex Global Enterprises</strong></td>
                  <td><span class="pill-badge" style="font-size: 0.7rem; padding: 2px 6px;">Customer</span></td>
                  <td>+91 98765 43210</td>
                  <td><strong style="color: var(--accent);">+₹45,000</strong></td>
                  <td>
                    <button class="btn btn-accent" style="padding: 0.35rem 0.85rem; font-size: 0.75rem;" onclick="sendWhatsAppReminder('Apex Global Enterprises', 45000)">
                      💬 WhatsApp (with UPI Link)
                    </button>
                  </td>
                </tr>
                <tr>
                  <td><strong>National Tech Supplies</strong></td>
                  <td><span class="pill-badge" style="background: #fef3c7; color: #d97706; font-size: 0.7rem; padding: 2px 6px;">Vendor</span></td>
                  <td>+91 91234 56780</td>
                  <td><strong style="color: var(--danger);">-₹18,500</strong></td>
                  <td>
                    <button class="btn btn-outline" style="padding: 0.35rem 0.85rem; font-size: 0.75rem;" onclick="alert('UPI payment link copied: upi://pay?pa=hisabhero@okhdfcbank&pn=NationalTech&am=18500')">
                      ⚡ Pay via UPI
                    </button>
                  </td>
                </tr>
        ...
        <div id="section-invoices" style="display: none;">
          <div class="data-table-card">
            <div class="flex justify-between items-center" style="margin-bottom: 1.5rem;">
              ...
              <button class="btn btn-primary" onclick="alert('Create Tax Invoice modal ready!')">+ Create Invoice</button>
            </div>
            ...
            <div class="flex gap-4" style="margin-bottom: 1.5rem;">
              <div style="flex: 1; background: var(--background); border: 1px solid var(--border); padding: 1rem; border-radius: 12px;">
                ...
                <div style="font-size: 1.35rem; font-weight: 900; color: var(--primary);">₹3,45,000</div>
              </div>
              <div style="flex: 1; background: #ecfdf5; border: 1px solid #a7f3d0; padding: 1rem; border-radius: 12px;">
                ...
                <div style="font-size: 1.35rem; font-weight: 900; color: #059669;">₹2,27,000</div>
              </div>
              <div style="flex: 1; background: #fef2f2; border: 1px solid #fecaca; padding: 1rem; border-radius: 12px;">
                ...
                <div style="font-size: 1.35rem; font-weight: 900; color: #dc2626;">₹1,18,000</div>
              </div>
            </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Reliance Retail Logistics<br /><span style="font-size: 0.75rem; color: var(--text-muted);">27AAACR1234F1Z5</span></td>
                  <td>18% (9% CGST + 9% SGST)</td>
                  <td style="font-weight: 800;">₹1,18,000</td>
                  <td><span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 6px;">✓ GST VERIFIED</span></td>
                  <td>
                    <button class="btn btn-outline" style="padding: 0.3rem 0.75rem; font-size: 0.75rem;" onclick="alert('Downloading GST Invoice PDF...')">
                      📥 Download PDF
                    </button>
                  </td>
                </tr>
          ...
          <div class="data-table-card">
            ...
            <div class="metrics-grid">
              <div class="metric-card">
                ...
                <div class="metric-value" style="color: var(--accent);">₹1,80,000</div>
                <div class="metric-sub">Confirmed Receivables</div>
              </div>
              <div class="metric-card">
                <div class="metric-title">Monthly Burn Rate</div>
                <div class="metric-value" style="color: var(--danger);">₹54,200</div>
                <div class="metric-sub">Operating Outflow</div>
              </div>
              <div class="metric-card">
                <div class="metric-title">Simulated Runway</div>
                <div id="simulatedRunwayVal" class="metric-value" style="color: var(--secondary);">12.4 Mos</div>
        ...
        <div id="section-inventory" style="display: none;">
          <div class="data-table-card">
            <h2 style="font-size: 1.5rem; margin-bottom: 0.5rem;">📦 Inventory Stock & Fixed Asset Depreciation</h2>
            <p style="color: var(--text-muted); font-size: 0.875rem; margin-bottom: 1.5rem;">Track stock levels, low-stock reorder warnings, and annual asset depreciation.</p>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><strong>MacBook Pro M3 (Dev Asset)</strong></td>
                  <td>Fixed IT Equipment</td>
                  <td>4 Units</td>
                  <td>₹1,80,000</td>
                  <td><span class="pill-badge" style="font-size: 0.7rem; padding: 2px 6px;">20% Straight-Line</span></td>
                </tr>
                <tr>
                  <td><strong>Packaging Carton Boxes</strong></td>
                  <td>Inventory Stock</td>
                  <td>250 Units</td>
                  <td>₹45</td>
                  <td><span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 6px;">IN STOCK</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div id="section-subscriptions" style="display: none;">
          <div class="data-table-card">
            <h2 style="font-size: 1.5rem; margin-bottom: 0.5rem;">🔁 SaaS & Recurring Subscriptions</h2>
            <p style="color: var(--text-muted); font-size: 0.875rem; margin-bottom: 1.5rem;">Track all active auto-debit tool subscriptions and renewal dates.</p>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><strong>Google Cloud & Workspace</strong></td>
                  <td>Monthly Auto-Debit</td>
                  <td>1st of Next Month</td>
                  <td style="font-weight: 800;">₹6,500/mo</td>
                  <td><span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 6px;">ACTIVE</span></td>
                </tr>
                <tr>
                  <td><strong>Airtel High-Speed Fiber</strong></td>
                  <td>Monthly Billing</td>
                  <td>In 12 Days</td>
                  <td style="font-weight: 800;">₹1,499/mo</td>
                  <td><span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 6px;">ACTIVE</span></td>
                </tr>
              </tbody>
            </table>
        ...
        <div id="section-reports" style="display: none;">
          <div class="data-table-card">
            ...
            <div style="background: var(--background); border: 1px solid var(--border); padding: 2rem; border-radius: 16px; text-align: center;">
              ...
              <button class="btn btn-primary" onclick="alert('Exporting verified P&L PDF report...')">
                📥 Export Audited P&L Report (PDF)
              </button>
            </div>
          </div>
        </div>
        ...
        <div id="section-merkle" style="display: none;">
          <div class="data-table-card">
            ...
            <div style="background: var(--background); border: 1px solid var(--border); padding: 1.5rem; border-radius: 14px; margin-bottom: 1.5rem;">
              ...
              <div style="font-family: monospace; font-size: 1rem; font-weight: 800; color: var(--secondary); margin-top: 4px;">
                0x7f2a89c04b3e81d765fa89012cdbe381f9a278bc0981e45da782163901bfa829
              </div>
        ...
        <div id="section-team" style="display: none;">
          <div class="data-table-card">
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><strong>Selvamanikandan</strong></td>
                  <td>selva@hisabhero.com</td>
                  <td><span class="pill-badge emerald" style="font-size: 0.7rem; padding: 2px 6px;">OWNER</span></td>
                  <td><strong style="color: var(--accent);">Active</strong></td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  <script>
    ...
    async function loadWorkspaceData() {
      ...
      try {
        ...
        if (Array.isArray(stats) && stats.length >= 3) {
          ...
          document.getElementById('statMargin').textContent = (margin >= 0 ? '+' : '') + '₹' + margin.toLocaleString('en-IN');
        }
        ...
        // Render Graphs
        renderFinancialCharts(txs, totalIn, totalOut);
      } catch (err) {
        console.error('Failed to load workspace data:', err);
      }
    }

    // ─── RENDER CHART.JS FINANCIAL GRAPHS ───
    function renderFinancialCharts(txs, totalIn, totalOut) {
      const cfCtx = document.getElementById('cashflowChart');
      if (cfCtx) {
        if (cashflowChartInstance) cashflowChartInstance.destroy();
        
        const labels = ['Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep (Proj)'];
        const inData = [42000, 58000, 72000, 89000, totalIn > 0 ? totalIn : 145000, 180000];
        const outData = [24000, 31000, 44000, 48000, totalOut > 0 ? totalOut : 54200, 62000];
      ...
      if (catCtx) {
        ...
        categoryChartInstance = new Chart(catCtx, {
          type: 'doughnut',
          data: {
            labels: ['Payroll', 'Marketing', 'SaaS / Cloud', 'Rent', 'Other'],
            datasets: [{
              data: [42, 24, 18, 16, 10],
              backgroundColor: ['#2563eb', '#059669', '#8b5cf6', '#f59e0b', '#64748b'],
              borderWidth: 2,
              borderColor: '#ffffff'
            }]
          },
        ...
        runwayChartInstance = new Chart(rwyCtx, {
          ...
          data: {
            ...
            datasets: [{
              ...
              data: [345000, 310000, 275000, 240000, 210000, 160000],
              borderColor: '#2563eb',
    ...
    function updateScenarioSim() {
      ...
      // Base runway: 12.4 months. Enhanced by rev/exp factors
      ...
      if (runwayChartInstance) {
        const base = [345000, 310000, 275000, 240000, 210000, 160000];
        const updated = base.map((v, i) => Math.round(v * (1 + (revPct - expPct * 0.5) * 0.01 * (i + 1))));
        runwayChartInstance.data.datasets[0].data = updated;
    ...
    function showSection(secName) {
      ...
      const sections = ['overview', 'transactions', 'invoices', 'khata', 'cashflow', 'inventory', 'subscriptions', 'reports', 'aichat', 'upload', 'merkle', 'team', 'settings'];
      ...
      if (secName === 'overview' || secName === 'cashflow') {
        setTimeout(() => {
          loadWorkspaceData();
        }, 100);
      }
...
console.log('Successfully written complete 11-module HisabHero platform to public/index.html!');
