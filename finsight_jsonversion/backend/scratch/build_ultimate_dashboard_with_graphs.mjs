...
<body>
  ...
  <div id="dashboardView" style="display: none;">
    ...
    <header class="dash-topbar">
      ...
      <!-- Right User Controls -->
      <div class="flex items-center gap-3">
        <button class="btn btn-outline" style="padding: 0.4rem 0.85rem; font-size: 0.8125rem;" onclick="openVoiceModal()">
          🎙️ Voice Bookkeeper
        </button>
    ...
    <div class="dash-layout">
      ...
      <main class="dash-main">
        ...
        <!-- SECTION 1: OVERVIEW DASHBOARD (WITH REAL INTERACTIVE GRAPHS) -->
        <div id="section-overview">
          ...
          <div class="charts-grid">
            <!-- Graph 1: Inflow vs Outflow Trend (Bar & Line Combo) -->
            ...
            <!-- Graph 2: Expense Category Breakdown (Donut) -->
            <div class="chart-card">
              <div class="flex justify-between items-center" style="margin-bottom: 1rem;">
                <div>
        ...
        <!-- SECTION 2: KHATA BOOK LEDGER -->
        <div id="section-khata" style="display: none;">
          <div class="data-table-card">
            <div class="flex justify-between items-center" style="margin-bottom: 1.5rem;">
              <div>
                <h2 style="font-size: 1.5rem;">📖 Khata Book Digital Ledger</h2>
                <p style="color: var(--text-muted); font-size: 0.875rem;">Manage Customer receivables and Vendor payables with WhatsApp 1-click reminders.</p>
              </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-accent" style="padding: 0.3rem 0.75rem; font-size: 0.75rem;" onclick="sendWhatsAppReminder('Apex Global Enterprises', 45000)">
                      💬 WhatsApp Reminder
                    </button>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-outline" style="padding: 0.3rem 0.75rem; font-size: 0.75rem;" onclick="alert('UPI settlement link copied!')">
                      ⚡ Pay via UPI
                    </button>
                  </td>
                </tr>
        ...
        <!-- SECTION 3: INVOICES & GST -->
        <div id="section-invoices" style="display: none;">
          <div class="data-table-card">
            <div class="flex justify-between items-center" style="margin-bottom: 1.5rem;">
              <div>
                <h2 style="font-size: 1.5rem;">🧾 Invoices & GST Filing Center</h2>
                <p style="color: var(--text-muted); font-size: 0.875rem;">Generate GST compliant tax invoices with CGST, SGST, IGST calculations.</p>
              </div>
        ...
        <!-- SECTION 4: CASH FLOW RUNWAY -->
        <div id="section-cashflow" style="display: none;">
          <div class="data-table-card">
            <h2 style="font-size: 1.5rem; margin-bottom: 0.5rem;">🌊 Cash Flow Waterfall & Runway Forecast</h2>
            <p style="color: var(--text-muted); font-size: 0.875rem; margin-bottom: 1.5rem;">Predictive cash flow modeling and burn rate calculations.</p>
            ...
            <div class="metrics-grid">
              ...
              <div class="metric-card">
                <div class="metric-title">Runway Reserve</div>
                <div class="metric-value" style="color: var(--secondary);">12.4 Mos</div>
        ...
        <!-- SECTION 8: DOCUMENT INTELLIGENCE UPLOAD -->
        ...
        <!-- SECTION 9: WORKSPACE SETTINGS & CONVERSION -->
  ...
  <div id="voiceModal" class="modal-backdrop">
    <div class="modal-box" style="text-align: center;">
      ...
      <p style="color: var(--text-muted); font-size: 0.875rem; margin-bottom: 1.5rem;">
        Speak naturally in English or Hindi:<br /><em>"Spent ₹2,400 on fuel today"</em>
      </p>
  ...
  <script>
    ...
    function renderFinancialCharts(txs, totalIn, totalOut) {
      // 1. Cashflow Inflow vs Outflow Bar Chart
        ...
        runwayChartInstance = new Chart(rwyCtx, {
          ...
          data: {
            ...
            datasets: [{
              ...
              data: [345000, 310000, 275000, 240000, 210000],
              borderColor: '#2563eb',
    ...
    function sendWhatsAppReminder(partyName, amount) {
      const msg = encodeURIComponent(\`Hello \${partyName}, this is a gentle reminder from HisabHero regarding your pending balance of ₹\${amount.toLocaleString('en-IN')}. Please pay using UPI or bank transfer. Thank you!\`);
    ...
    function showSection(secName) {
      ...
      if (secName === 'cashflow' && items[4]) items[4].classList.add('active');
      if (secName === 'subscriptions' && items[5]) items[5].classList.add('active');
      if (secName === 'reports' && items[6]) items[6].classList.add('active');
      if (secName === 'aichat' && items[7]) items[7].classList.add('active');
      if (secName === 'upload' && items[8]) items[8].classList.add('active');
      if (secName === 'settings' && items[9]) items[9].classList.add('active');
...
fs.writeFileSync(htmlPath, ultimateHtml, 'utf8');
console.log('Successfully written complete Ultimate Dashboard with interactive graphs and all legacy features!');
